...
// Avoids "go.info.runtime.itabTable: relocation target go.info.*github.com/eihigh/goloader.itabTableType not defined"
var itabTableTyped = (**itabTableType)(unsafe.Pointer(&itabTable))

//go:linkname itabLock runtime.itabLock
var itabLock uintptr

// Avoids "go.info.runtime.itabLock: relocation target go.info.github.com/eihigh/goloader.mutex not defined"
